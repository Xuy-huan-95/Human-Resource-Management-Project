...
const TableProcessApprove = (props: ITableProcessApprove) => {
    ...
    const { handlShowHideRegisterFormModal, rowsPerPage, page, handleChangePage, handleChangeRowsPerPage } = props
    const { data, isLoading } = useGetProccessLeaderCurrentQuery("", { refetchOnMountOrArgChange: true })
